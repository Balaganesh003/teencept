...
function Teenhall() {
  return (
    <>
      <div className=" max-w-[1280px] mx-auto w-full h-full">
        <div className=" flex flex-col sm:flex-row w-full ">
          <div className="sm:w-[55%] w-full px-[30px] sm:px-0 sm:pt-[150px] pt-[70px]  h-full">
            ...
            <p className=" text-[#595959] mt-[40px] pl-0 sm:ml-[80px] ml-0 leading-normal sm:pb-[206px] md:max-w-[602px] w-full font-Inter text-[1.25rem] font-[400] tracking-[-0.3px]">
          ...
          <div className="sm:w-[45%] w-full h-[510px] relative  sm:mx-[30px] sm:px-0  ">
            <div className="flex mt-[77px] ">
              ...
              <div className='w-[150px] h-[150px]  mx-[23px]'>
                    <img src='https://ik.imagekit.io/nhuikqpll/teenhive_teenhall/Rectangle%2012-min.png'
                    className=' object-cover '
                    alt='as'
                    />
                </div>
                <div className='w-[150px] h-[150px]  mx-[23px]'>
                    <img src='https://ik.imagekit.io/nhuikqpll/teenhive_teenhall/Rectangle%2013-min.png'
                    className=' object-cover '
                    alt='as'
                    />
                </div>
                <div className='w-[150px] h-[150px]  mx-[23px]'>
                    <img src='https://ik.imagekit.io/nhuikqpll/teenhive_teenhall/Vector-min.png'
                    className=' object-cover '
                    alt='as'
                    />
                </div>
              ...
              <div className='w-[150px] h-[150px]  mx-[23px]'>
                    <img src='https://ik.imagekit.io/nhuikqpll/teenhive_teenhall/Ellipse%201-min.png'
                    className=' object-cover '
                    alt='as'
                    />
                </div>
                <div className='w-[300px] h-[150px]  mx-[23px]'>
                    <img src='https://ik.imagekit.io/nhuikqpll/teenhive_teenhall/Rectangle%2014-min.png'
                    className=' object-cover '
                    alt='as'
                    />
                </div>
      ...
      <div className="w-full  sm:mt-0 h-full bg-[#FC6243] ">
        <div className=" max-w-[1280px] mx-auto w-full py-[18px] h-[60px] ">
          <Marquee
            ...
            <p className=" font-Inter text-[#fff] text-[1.15rem] sm:text-[1.25rem] font-[500] tracking-[-0.2px]">
              {' '}
              TeenHall by TeenHive - an exclusive idea discovery and teen
              networking event
            </p>
            <div className="h-[25px] w-[25px] ml-[10px]">
              <svg
      ...
      <div className=" w-full h-full bg-[#F4F4F4] relative">
        <div className=" px-[30px] sm:px-[100px] max-w-[1280px] mx-auto grid sm:grid-cols-2 gap-[30px] grid-cols-1">
          <div className="w-full h-full">
            <p className=" text-[#2C04BD] sm:mt-[104px] mt-[52px] sm:mb-[57px] mb-[40px] font-Domine text-[2rem]  sm:text-[2.25rem] font-[700] tracking-[-1.08px]">
              Age is just a number!
            </p>
            <p className=" text-[#595959] w-full sm:w-[95%] sm:mb-[140px] font-Inter text-[18px] font-[400] tracking-[-0.18px]">
          ...
          <div className=" w-full h-full flex items-center">
            <p className=" text-[#595959] w-[90%] mt-0 sm:mt-[50px] mb-[50px] sm:mb-0 font-Inter text-[18px] font-[400] tracking-[-0.18px]">
        ...
        <div className=" absolute bottom-[-8%] sm:bottom-[-3%] rotate-45 right-[60px] sm:right-[116px]  w-[70px] sm:w-[100px] bg-red-500 h-[100px] sm:h-[135px]">
          <img
      ...
      <div className=" w-full pb-[132px] h-full max-w-[1280px] mx-auto flex flex-col items-center">
        <p className=" text-[#2C04BD] px-[30px] sm:px-0 mt-[105px] mb-[44px] font-Domine text-[2rem] font-[700] tracking-[-0.48px]">
          Ready to unlock your potential?
        </p>
        <p className=" text-[#595959] font-Inter text-[18px] w-full px-[30px] sm:w-[62.5%] font-[400] tracking-[-0.18px]">
        ...
        <p className=" text-[#595959] mt-[44px] font-Inter text-[18px] w-full px-[30px] sm:w-[62.5%] font-[400] tracking-[-0.18px]">
      ...
      <div className=" bg-[#F4F4F4] pb-[60px] w-full h-full">
        <div className=" max-w-[1280px] w-full h-full mx-auto">
          <div className="w-full h-full flex justify-center">
            <p className=" text-[#2E2E2E] pt-[86px] w-full px-[30px] sm:w-[48.4375%] text-center font-Inter text-[1.5rem] font-[500] tracking-[-0.72px]">
              Dive in to discover some fantastic ideas and projects and stand a
              chance to win some unbelievable prizes.
            </p>
          </div>
          <div className=" mt-[65px] w-full h-full flex flex-wrap justify-center">
            {data.map((item, index) => {
              return (
                <>
      ...
      <div className="">
        <div className=" w-full h-full  sm:py-[100px] py-[50px] bg-[#fff] flex justify-center ">
          <p className=" text-[#2C04BD]  w-full px-[30px] sm:w-[64.0625%] font-Domine  text-[1.75rem] sm:text-[2rem] font-[700] tracking-[-0.64px]">
      ...
      <div className="bg-[#F4F4F4] pb-[90px] w-full h-full">
        <div className="mx-auto max-w-[1280px] w-full h-full">
          <p className=" text-center sm:pt-[90px] pt-[50px] pb-[60px] font-Inter text-[24px] tracking-[-0.72px]  font-[500] ">
            TeenHall August Calendar
          </p>
          <div className=" max-w-[80%] mx-auto w-full h-full">
            <div className="sm:w-[400px] w-full mx-[30px] h-[400px]">
              <img
