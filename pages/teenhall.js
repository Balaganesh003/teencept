    ...
    <>
      <div className=" max-w-[1280px] mx-auto w-full h-full">
        <div className=" flex flex-col sm:flex-row w-full ">
          <div className="sm:w-[55%] w-full px-[30px] sm:px-0 pt-[150px]  h-full">
            ...
            <p className=" text-[#595959] mt-[40px] pl-0 sm:ml-[80px] leading-normal pb-[206px] md:max-w-[602px] w-full font-Inter text-[1.25rem] font-[400] tracking-[-0.3px]">
          ...
          <div className="sm:w-[45%] w-full relative mx-[30px] h-full sm:px-0 bg-red-500 "></div>
        </div>
      </div>
      <div className="w-full h-full bg-[#FC6243] ">
      ...
      <div className=" w-full h-full bg-[#F4F4F4] relative">
        <div className=" px-[30px] sm:px-[100px] max-w-[1280px] mx-auto grid sm:grid-cols-2 gap-[30px] grid-cols-1">
          ...
          <div className=" w-full h-full flex items-center">
            <p className=" text-[#595959] w-[90%] mt-[50px] mb-[50px] sm:mb-0 font-Inter text-[18px] font-[400] tracking-[-0.18px]">
        ...
        <div className=" absolute bottom-[-3%] rotate-45 right-[116px]  w-[100px] bg-red-500 h-[135px]">
<img src="/images/teenhall/83f1f88eb6038ccef5d4fbbed6915b44.jpeg"
alt="as"
